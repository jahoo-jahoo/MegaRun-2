...
def name():
        ...
        print("--------------------------------,\n")
        print("| Author    : Annoy Creations   |,\n")
        print("| Telegrame : t.me/hackerrdt    |,\n")
        print("| FaceBook  : Network Hacker    |,\n")
        print("--------------------------------,\n")
print(name(),"\n")
...
def main():
    ...
    while True:
        ...
        if resp == '<Response [204]>':
            ...
            print(bar)
            print("\n\033[1;32;40m [#] $ You Won Data $... [#]")
            print(bar)
        else:
            print(bar)
            print("\n\033[1;31;40m [#] Check Again, You may be a Blocked User... [#]")
            print(bar)
